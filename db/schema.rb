...
ActiveRecord::Schema[7.1].define(version: 2026_06_08_181023) do
  ...
  create_table "cached_audios", force: :cascade do |t|
    ...
    t.index ["lookup_key"], name: "index_cached_audios_on_lookup_key", unique: true
  end
  ...
  create_table "memories", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["capsule_id"], name: "index_memories_on_capsule_id"
  end
  ...
  create_table "voice_samples", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_voice_samples_on_user_id"
  end

  add_foreign_key "active_storage_attachments", "active_storage_blobs", column: "blob_id"
  add_foreign_key "active_storage_variant_records", "active_storage_blobs", column: "blob_id"
  add_foreign_key "capsules", "users"
  add_foreign_key "memories", "capsules"
  add_foreign_key "voice_samples", "users"
end
